...
Pod::Spec.new do |s|
  ...
  s.source                = { :http => "https://github.com/VM-Mobile-SDK/nextgen-adsdk-ios-release/releases/download/5.4.0/AdSDKCore-5.4.0.zip" }

  s.ios.vendored_frameworks = "AdSDKCore.xcframework"
end