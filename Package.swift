...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://api.github.com/repos/VM-Mobile-SDK/nextgen-adsdk-ios-release/releases/assets/107238472.zip",
            checksum: "b169a117044d2cd78894b1d6159b63a8c126856e4974fb852fb7a3ab451d35ac"
        )
    ]
